...
def posicion_falsa(
    ...
    lado_fijo: str | None = None  # para Illinois
...
def animar_posicion_falsa(
    ...
    xi_inicial: float,
    xd_inicial: float,
    titulo: str = "Método de Posición Falsa",
    guardar_gif: bool = False,
    nombre_gif: str = "posicion_falsa.gif",
    fps: int = 2,
